"""
ui.windows.offline_window -- Offline mode window.

Independent recording playback window that can run alongside Live or Configuration.
"""
...
class OfflineWindow(QMainWindow):
    """Top-level window for Offline mode."""
    ...
    def on_mode_deactivated(self) -> None:
        """Called when Offline mode is deactivated."""
        self._offline_widget.on_mode_deactivated()
...
__all__ = ["OfflineModeWidget", "OfflineImageWidget", "OfflineWindow"]